...
const wchar_t* D3D12MeshletRender::c_meshFilename = L"..\\Assets\\123.bin";
const wchar_t* c_texturePath = L"..\\Assets\\123.png";
...
void D3D12MeshletRender::OnUpdate()
{
    ...
    XMMATRIX world = XMMatrixScaling(5, 5, 5)* XMMatrixTranslation(0.0f, 100.0f, 0.0f);
